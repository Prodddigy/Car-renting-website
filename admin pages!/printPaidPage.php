...
// 
      ...
      // this part is exclusively for admin, so when printed all bookings 
      //from that User will be updated as 'Paied' from defualt 'unpaid
$UpdateQ = "UPDATE Booking
...
<FORM METHOD="LINK" ACTION="chooseAdmin.php"> 
<INPUT TYPE="submit" VALUE="Go back to Admin Page"> </FORM>    
